...
# Then starts two cloudflared tunnels and prints both URLs.
#
# Usage:
...
if ($cloudflared) {
    ...
    Write-Host "  |                                                     |" -ForegroundColor Green
    if ($apiUrl) {
        Write-Host "  |  App Backend URL (paste into app Settings gear):    |" -ForegroundColor Green
    ...
    Write-Host "  |                                                     |" -ForegroundColor Green
    Write-Host "  |  Twilio -> Messaging -> Sandbox settings            |" -ForegroundColor Green
    ...
    Write-Host "  Start manually: cloudflared tunnel --url http://localhost:5001" -ForegroundColor Gray
}
